...
customers_df.repartition(1).write.parquet(f"s3://datalake-rawzone-group1dbda/Customers/Customers_historic/{current_date_string}/")

articles_df.repartition(1).write.parquet(f"s3://datalake-rawzone-group1dbda/Articles/Articles_historic/{current_date_string}/")
